 ...
 * @author Suporte
 */
public class ReqAutorizador extends javax.swing.JFrame {

    /**
     * Creates new form ReqFuncionarios
     */
    public ReqAutorizador() {
        initComponents();
   ...
   c.getNome()
    ...
    private void TabelaFuncionariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaFuncionariosMouseClicked
        ...
        ReqCompras req = ReqCompras.x;
           ...
           req.autorizador.setText(TabelaFuncionarios.getValueAt(TabelaFuncionarios.getSelectedRow(), 0).toString()); 
           req.lblAutoriazador.setText( TabelaFuncionarios.getValueAt(TabelaFuncionarios.getSelectedRow(), 1).toString());  
           req.setVisible(true);
           this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReqAutorizador.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
